  ...
  pkgs = hackage:
    {
      packages = {
        ...
        "multibase".revision = (((hackage."multibase")."0.1.2").revisions).default;
        ...
        "ipld-cid".revision = (((hackage."ipld-cid")."0.1.0.0").revisions).default;
        ...
        "multihash-cryptonite".revision = (((hackage."multihash-cryptonite")."0.1.0.0").revisions).default;
        ...
        "binary-varint".revision = (((hackage."binary-varint")."0.1.0.0").revisions).default;
        ...
        "leb128-binary".revision = (((hackage."leb128-binary")."0.1.1").revisions).default;
        ...
        "base32-z-bytestring".revision = (((hackage."base32-z-bytestring")."1.0.0.0").revisions).default;
  ...
  extras = hackage:
    {
      packages = {
        ...
        marlowe-ici = ./.plan.nix/marlowe-ici.nix;
    ...
    ({ lib, ... }:
      {
        packages = {
          ...
          "plutus-pab-executables" = {
            flags = { "defer-plugin-errors" = lib.mkOverride 900 true; };
            };
    ...
    ({ lib, ... }:
      {
        packages = {
          ...
          "cpu".components.library.planned = lib.mkOverride 900 true;
          ...
          "multibase".components.setup.planned = lib.mkOverride 900 true;
          ...
          "multibase".components.library.planned = lib.mkOverride 900 true;
          ...
          "ipld-cid".components.library.planned = lib.mkOverride 900 true;
          ...
          "binary-varint".components.library.planned = lib.mkOverride 900 true;
          ...
          "marlowe-ici".components.exes."marlowe-ici".planned = lib.mkOverride 900 true;
          ...
          "leb128-binary".components.library.planned = lib.mkOverride 900 true;
          ...
          "multihash-cryptonite".components.library.planned = lib.mkOverride 900 true;
          ...
          "multihash-cryptonite".components.setup.planned = lib.mkOverride 900 true;
          ...
          "base32-z-bytestring".components.library.planned = lib.mkOverride 900 true;
          "marlowe-ici".components.library.planned = lib.mkOverride 900 true;
          ...
          "sandi".components.library.planned = lib.mkOverride 900 true;
